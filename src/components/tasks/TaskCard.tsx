...
export const TaskCard = ({ task, canEdit }: TaskCardProps)=> {
    ...
    return (
        <li className="flex justify-between p-5 bg-white border border-slate-300">
            <div className="min-w-0 flex flex-col gap-y-4" 
                ...
                >
                <button type="button" className="text-xl font-bold text-slate-500 text-left">{task.name}</button>
